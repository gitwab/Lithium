...
function Lithium:CreateWindow(opts)
	...
	local function openUI()
		...
		Main.Position=UDim2.new(0.5,-W/2,0.5,-H/2+10)
		Content.Visible=true; TabBar.Visible=true
		tween(Main,{Size=UDim2.new(0,W,0,H),BackgroundTransparency=0,Position=UDim2.new(0.5,-W/2,0.5,-H/2)},0.4,Enum.EasingStyle.Quint)
	end

	local function closeUI()
		visible=false
		tween(Main,{Size=UDim2.new(0,W,0,H*0.94),BackgroundTransparency=1,Position=UDim2.new(0.5,-W/2,0.5,-H/2+10)},0.3,Enum.EasingStyle.Quint)
		task.delay(0.32,function() if not visible then Main.Visible=false; Main.Size=UDim2.new(0,W,0,H); Main.Position=UDim2.new(0.5,-W/2,0.5,-H/2); Main.BackgroundTransparency=0 end end)
	end
	...
	closeBtn.MouseButton1Click:Connect(function()
		tween(Main,{Size=UDim2.new(0,W,0,H*0.94),BackgroundTransparency=1,Position=UDim2.new(0.5,-W/2,0.5,-H/2+10)},0.28,Enum.EasingStyle.Quint)
	...
	if ksOpts and ksOpts.Enabled~=false then
		...
		kBox.BackgroundTransparency=0.05; stroke(kBox,T.Border,1,0); makeShadow(kBox)
		...
		confBtn.MouseButton1Click:Connect(function()
			if kTb.Text==ks.Key then
				...
				tween(keyBlur,{Size=0},0.35,Enum.EasingStyle.Quint)
				...
				task.delay(0.38,function() keyBlur:Destroy(); ksg:Destroy() end)
			else
	...
	Main.Size = UDim2.new(0, W * 0.92, 0, H * 0.92)
	Main.Position = UDim2.new(0.5, -(W * 0.92)/2, 0.5, -(H * 0.92)/2 - 12)
	...
	task.delay(0.45, function()
		local borderStroke = Main:FindFirstChildOfClass("UIStroke")
		if borderStroke then
			tween(borderStroke, {Transparency = 0.0}, 0.1)
		end
		tween(Main, {
			Size     = UDim2.new(0, W - 4, 0, H - 4),
			Position = UDim2.new(0.5, -(W-4)/2, 0.5, -(H-4)/2),
